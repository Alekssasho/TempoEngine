...
impl<'a> MeshMapping<'a> {
  ...
  pub fn vertex_offset(&self) -> u32 {
    self._tab.get::<u32>(MeshMapping::VT_VERTEX_OFFSET, Some(0)).unwrap()
  }
  #[inline]
  pub fn vertex_count(&self) -> u32 {
    self._tab.get::<u32>(MeshMapping::VT_VERTEX_COUNT, Some(0)).unwrap()
  }
}
...
impl<'a: 'b, 'b> MeshMappingBuilder<'a, 'b> {
  ...
  pub fn add_vertex_offset(&mut self, vertex_offset: u32) {
    self.fbb_.push_slot::<u32>(MeshMapping::VT_VERTEX_OFFSET, vertex_offset, 0);
  }
  #[inline]
  pub fn add_vertex_count(&mut self, vertex_count: u32) {
    self.fbb_.push_slot::<u32>(MeshMapping::VT_VERTEX_COUNT, vertex_count, 0);
  }
  #[inline]
